...
(function() {
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.compileNode = function(o) {
      var isValue, match, name, val, varBase, _ref2, _ref3, _ref4, _ref5, _ref6;
      if (isValue = this.variable instanceof Value) {
        ...
        if ((_ref3 = this.context) === ':=' || _ref3 === ':-' || _ref3 === '<-' || _ref3 === '=:=') {
          return this.compileEvent(o);
        }
      }
    ...
    Assign.prototype.compileEvent = function(o) {
      var eventOps, op, variable;
      eventOps = {
        ":=": 'on',
        ":-": 'off',
        '<-': 'trigger',
      ...
      variable = this.variable.compile(o);
      op = eventOps[this.context];
      return "" + (utility(op)) + ".call(" + variable + " || (" + variable + " = {}), " + (this.value.compile(o)) + ")";
    };
  ...
  UTILITIES = {
    ...
    on: function() {
      ...
      return function(callback) {
        __prepareHandler(this);
        return this.__event_handler.push(callback);
      };
    },
    off: function() {
      utility('prepareHandler');
      return function(e) {
        ...
        if ((t = this.__event_handler.indexOf(e)) > -1) {
          return ([].splice.apply(this.__event_handler, [t, t - t + 1].concat(_ref2 = [])), _ref2);
        }
      };
    },
    advise: function() {
      ...
      return function(advisor) {
        __prepareHandler(this);
        return this.__event_advisor.push(advisor);
      };
    },
    trigger: function() {
      utility('prepareHandler');
      return function(e) {
        var advice, callback, _e, _i, _j, _len, _len1, _ref2, _ref3;
        __prepareHandler(this);
        this.last = {
          event: e,
          exception: null
        };
        _ref2 = this.__event_advisor;
        for (_i = 0, _len = _ref2.length; _i < _len; _i++) {
          advice = _ref2[_i];
          try {
            _e = advice(e);
    ...
    prepareHandler: function() {
      return function(o) {
        ...
        return o.__event_advisor = o.__event_advisor || [];
      };
    }
  };
