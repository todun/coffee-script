...
(function() {
  ...
  exports.Assign = Assign = (function(_super) {
    ...
    Assign.prototype.compileNode = function(o) {
      ...
      if (isValue = this.variable instanceof Value) {
        ...
        if (this.context === ':=') {
          return this.compileEventBind(o);
        }
        if (this.context === '<-') {
          return this.compileEventTrigger(o);
        }
      }
    ...
    Assign.prototype.compileEventBind = function(o) {
      return "" + (utility('on')) + ".call(" + this.variable.base.value + ", " + (this.value.compile(o)) + ")";
    };

    Assign.prototype.compileEventTrigger = function(o) {
      return "" + (utility('trigger')) + ".call(" + this.variable.base.value + ", " + (this.value.compile(o)) + ")";
    };
  ...
  UTILITIES = {
    ...
    on: function() {
      return "function(callback) { this.__event_handler = this.__event_handler || []; this.__event_handler.push(callback) }";
    },
    trigger: function() {
      return "function(e) { var callback, _i, _len, _ref; _ref = this.__event_handler; for (_i = 0, _len = _ref.length; _i < _len; _i++) {callback = _ref[_i]; callback(e); } return 0; }";
    }
  };
